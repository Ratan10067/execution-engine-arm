...
class Settings:
    ...
    def __init__(self, conf_file: Optional[str] = None):
        ...
        self.MAX_MAX_PROCESSES_AND_OR_THREADS: int = get_val("MAX_MAX_PROCESSES_AND_OR_THREADS", 240, int)
        ...
        self.MAX_MAX_FILE_SIZE: int = get_val("MAX_MAX_FILE_SIZE", 102400, int)
